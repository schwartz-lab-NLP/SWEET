...
class DebertaForSequenceClassification(DebertaPreTrainedModel):
    ...
    def calibrate_lte_logits(self, lte_logits, layer_idx):
        lte_logits = torch.div((lte_logits.cpu() - self.min_lte_layer_predictions[layer_idx]), self.max_min_diff[layer_idx])
    ...
    def forward(
        ...
        return SequenceClassifierOutput(
            loss=loss, logits=exit_layer_logits.squeeze(1).unsqueeze(0), hidden_states=fake_hidden_states, attentions=outputs.attentions
        )
